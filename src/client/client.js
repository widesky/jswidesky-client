...
const clientRealtimeFunctions = require("./functions/realtime");
...
class WideSkyClient {
    ...
    assignSubFunctions() {
        ...
        // Assign realtime functions as direct methods so call sites remain
        // `client.watchSub(...)`, `client.pointWrite(...)`, etc. (their source
        // is grouped in ./functions/realtime.js).
        for (const [name, func] of Object.entries(clientRealtimeFunctions)) {
